...
After a number of years I have stopped releasing and supporting Karma Firewall on Google Play and have now moved Karma Firewall to F-Droid.
...
So please do not send any requests for customisation that would require Karma Firewall to inspect a users traffic.
